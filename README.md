...
Data quality checks and cleaning in Python
Exploratory Data Analysis (EDA) to identify patterns
Logistic Regression modeling for attrition drivers
SQL-based KPI validation to ensure metric consistency
Power BI dashboard development for leadership reporting
